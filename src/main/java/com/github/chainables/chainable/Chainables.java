...
public final class Chainables {
     ...
     * @param nextItemExtractor
     * @return a chain consisting of the specified {@code items}, followed by items generated by the specified {@code nextItemExtractorFromLastTwo} function passed
     * the last two items as its arguments.
     ...
     * @param items items to start the chain with
     * @param nextItemExtractor
     * @return a chain consisting of the specified {@code items}, followed by items generated by the specified {@code nextItemExtractor} function passed
     * the last item and the sequential index of the item to be generated as its arguments
     * @see Chainable#chainIndexed(BiFunction)
     */
